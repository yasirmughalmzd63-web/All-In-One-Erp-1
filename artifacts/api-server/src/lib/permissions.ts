...
export function requireAdminOrManager(req: Request, res: Response): boolean {
  if (req.userRole === "admin" || req.userRole === "super_admin" || req.userRole === "manager") return true;
...
export function isAdminOrManager(req: Request): boolean {
  return req.userRole === "admin" || req.userRole === "super_admin" || req.userRole === "manager";
}
